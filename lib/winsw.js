module.exports = {
  ...
  createExe: function(name,dir,callback){
	...
	var configFile = p.join(dir,name.replace(/[^\w]/gi,'').toLowerCase()+'.exe.config')
	var configData = "<configuration><startup><supportedRuntime version=\"v2.0.50727\" /><supportedRuntime version=\"v4.0\" sku=\".NETFramework,Version=v4.0\"/></startup><runtime><NetFx40_LegacySecurityPolicy enabled=\"true\"/></runtime></configuration>"
